...
export const WithBulkActions: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Les actions groupées (`bulkActions`) reçoivent les lignes sélectionnées (`T[]`) et un `clearSelection`. Ici, chaque action ouvre d'abord une popup de confirmation listant les objets sélectionnés ; l'action réelle (et `clearSelection`) n'est exécutée qu'à la validation.\n\nDès qu'au moins une ligne est sélectionnée, le clic sur une ligne coche/décoche sa case au lieu de déclencher `onRowClick`/`onRowNavigate` : sélectionnez une ligne via sa case, puis cliquez n'importe où sur les autres lignes pour étendre la sélection sans risque de navigation.",
      },
    },
  },
