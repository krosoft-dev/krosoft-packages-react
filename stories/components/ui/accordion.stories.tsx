  ...
  render: () => (
    <Accordion type="multiple" className="w-full">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>Yes. In multiple type, multiple items can be open at the same time.</AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>What about single type?</AccordionTrigger>
        <AccordionContent>In single type, only one item can be open at a time.</AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
};
